...
public class Utils {
	...
	public static void listar() {
		...
		String link = ""; //Inserir aqui o link do banco na Web
		...
		try {
			...
			if((int)obj.getInt("total_rows") > 0) {
				...
				for(Object produto : produtos) {
					...
					JSONObject prod = (JSONObject)doc.getJSONObject("doc");
					
					System.out.println("ID: " + prod.get("_id"));
					System.out.println("Rev: " + prod.get("_rev"));
					System.out.println("Produto: " + prod.get("produto"));
	...
	public static void atualizar() {
		...
		try {
			...
			System.out.println("Houve um erro durante a execução.");
			e.printStackTrace();
		}catch(InterruptedException e) {
			System.out.println("Houve um erro durante a execução.");
			e.printStackTrace();
